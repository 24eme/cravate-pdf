    ...
    <div class="card h-100">
      <div class="card-body">
        ...
        <div class="text-center">
          <a href="<?php echo Base::instance()->alias('procedure_submission_new', ['procedure' => $procedure->name, 'user' => $user]) ?>" class="btn btn-primary mt-2 d-block"><i class="bi bi-file-earmark-plus"></i> Saisir le dossier</a>
