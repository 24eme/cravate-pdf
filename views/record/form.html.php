...
<div class="col-6 offset-3 mt-3 justify-content-center">
  ...
  <?php if ($field['type'] == 'text'): ?>
    ...
    <input type="text" class="form-control" name="<?php echo $id ?>" id="<?php echo $field['type'].'_'.$id ?>"<?php if (isset($field['required']) && $field['required']): ?> required="required"<?php endif; ?><?php if (isset($field['disabled']) && $field['disabled']): ?> disabled<?php endif; ?> value="<?php echo \Helpers\Old::instance()->get($id, $submission->getDatas($id)) ?>">
  ...
  <?php if ($field['type'] == 'radio'): ?>
    <div class="mb-3">
      ...
      <div class="form-check">
        <input class="form-check-input" name="<?php echo $id ?>" value="<?php echo $choiceKey ?>" id="option_<?php echo $id ?>_<?php echo $choiceKey ?>" type="radio"<?php if (isset($field['required']) && $field['required']): ?> required="required"<?php endif; ?><?php if (isset($field['disabled']) && $field['disabled']): ?> disabled<?php endif; ?> <?php echo $submission->getDatas($id) === $choiceKey ? "checked" : null ?>>
